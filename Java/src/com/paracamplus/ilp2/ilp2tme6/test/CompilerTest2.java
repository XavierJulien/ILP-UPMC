...
import com.paracamplus.ilp2.ilp2tme6.parser.ILPMLParser2;
import com.paracamplus.ilp2.parser.xml.XMLParser;

@RunWith(Parameterized.class)
public class CompilerTest2 extends com.paracamplus.ilp2.compiler.test.CompilerTest {
    ...
    public CompilerTest2(final File file) {
    	super(file);
    }    
    ...
    public void configureRunner(CompilerRunner run) throws CompilationException {
        ...
        try {
			run.setILPMLParser(new ILPMLParser2(factory));
