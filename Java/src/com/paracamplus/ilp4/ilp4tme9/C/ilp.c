...
int nb_call_find_method_global = 0;
int nb_call_find_method_line = 0;
int nb_call_done = 0;
...
/*ILP_general_function
ILP_find_method_line_cache (
		ILP_Object receiver,
        ILP_Method method,
        int argc){
		static ILP_Class c01[10];
		static ILP_Method m01[10];
		static int a01[10];
		static ILP_general_function call[10];
		int i;
		for(i =0; i<10; i++){
			if(c01[i]==receiver->_class){
